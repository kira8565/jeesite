...
<body>
	<ul class="nav nav-tabs">
		...
		<shiro:hasPermission name="wx:wxPublicmanager:edit"><li><a href="${ctx}/wx/wxPublicmanager/form">微信公众号添加</a></li></shiro:hasPermission>
	</ul>
	<form:form id="searchForm" modelAttribute="wxPublicmanager" action="${ctx}/wx/wxPublicmanager/" method="post" class="breadcrumb form-search">
	...
	<table id="contentTable" class="table table-striped table-bordered table-condensed">
		<thead>
			<tr>
				...
				<th>备注信息</th>
				<th>消息加密方式</th>
				<shiro:hasPermission name="wx:wxPublicmanager:edit"><th>操作</th></shiro:hasPermission>
			</tr>
		</thead>
		<tbody>
		<c:forEach items="${page.list}" var="wxPublicmanager">
			<tr>
				...
				<shiro:hasPermission name="wx:wxPublicmanager:edit"><td>
    				<a href="${ctx}/wx/wxPublicmanager/form?id=${wxPublicmanager.id}">修改</a>
					<a href="${ctx}/wx/wxPublicmanager/delete?id=${wxPublicmanager.id}" onclick="return confirmx('确认要删除该微信公众号吗？', this.href)">删除</a>
